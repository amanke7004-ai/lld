...
public class BallPen extends Pen implements Refillable {
    ...
    public BallPen(String name, String brand, double price, Refill refill, ClosingType closingType){
        super(brand, name, price, PenType.BALL_PEN, closingType);
        this.refill = refill;
    ...
    @Override
    public void open() {
        System.out.println("opening ball pen via : " + closingType);
    }

    @Override
    public void close() {
        System.out.println("closing ball pen via : " + closingType);

    }

    @Override
    public void write() {
        System.out.println("Writing with Ball Pen with details :: \nBrand : " + this.brand  + "\nColor : " + this.refill.getInk().getInkColor() + "\nPenType: " + this.penType + "\nPen Price: " + this.price);
    }


    @Override
    public void refill(Refill refill) {
        System.out.println("Refilling Ball Pen with new Refill of color : " + refill.getInk().getInkColor());
    }
}
